...
import ThreejsUtil from "./threejs.util";
...
export default  class AnimateCharacter {
    ...
    addTransformControl=( bone )=>{
        var control = new TransformControls( this._editor.camera, this._editor.renderer.domElement );
        control.attach( bone );
    ...
    //method that make the model follow the camera
    lookAtCamera=( )=> {
        if(this._fbxModel) {
